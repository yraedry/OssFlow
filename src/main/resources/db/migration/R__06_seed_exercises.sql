-- R__06_seed_exercises.sql
-- Ejercicios físicos para BJJ (owner_id=1). Idempotente.
-- Consolida: V218 (90 ejercicios), V228 (45 ejercicios movilidad BJJ).
-- Depende de: V238 (ux_exercise_owner_name_active)
-- Nota: cada INSERT es individual para garantizar compatibilidad con el parser de Flyway.
