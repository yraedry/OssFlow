-- R__01_seed_federations.sql
-- Federaciones BJJ/Grappling oficiales. Idempotente: ON CONFLICT DO NOTHING.
-- Se ejecuta en toda instalación limpia después de todas las V__ migrations.

INSERT INTO federation (code, name, official_url, created_at, updated_at)
VALUES
